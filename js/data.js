...
export const BASE_DESTINATIONS = [
  ...
  // ==========================================
  {
    ...
    tier: "hub",
    regionId: "japan",
    tagline: "Hyper-Modern Metropolis & Serene Traditional Shrines",
    description: "Where neon skyscrapers reflect ancient temple ponds, Tokyo blends futuristic tech, serene gardens, and the world's highest density of Michelin stars.",
    lat: 35.6762,
    lng: 139.6503,
    elevation: "40m",
    ...
    livingSpaces: [
      {
        ...
        lat: 35.6870,
        lng: 139.7640,
        tags: ["Panoramic Fuji Views", "Black Basalt Pool", "Minimalist Zen"],
        amenities: ["Deep Granite Furo Soaking Tub", "30-meter Skyline Pool", "Engawa Living Lounge", "Bespoke Tea Sommelier"],
        description: "Hovering high above the Financial District, Aman Tokyo combines soaring washi paper ceilings with serene minimalist Japanese stone design."
      }
    ],
    activities: [
      {
...
/**
 * Pre-configured Showcase Travel Plans:
 * 1. NYC & Tokyo Highlights (Monday NYC, Friday Tokyo)
 * 2. South American Wonders (Monday Machu Picchu, Friday São Paulo)
 */
export const NYC_TOKYO_SHOWCASE_PLAN = {
  id: "nyc-tokyo",
  title: "Global Metropolises: NYC & Tokyo Highlights",
  traveler: "Alex Morgan",
  startDate: "2026-10-12",
  currency: "USD",
  collaborators: [
    { username: "alex_traveler", name: "Alex Morgan", role: "Trip Organizer", avatar: "👨‍✈️", status: "online" },
    { username: "sarah_explorer", name: "Sarah Chen", role: "Co-Planner", avatar: "👩‍💼", status: "online" },
    { username: "david_k", name: "David Kim", role: "Traveler", avatar: "🧑‍💻", status: "offline" }
  ],
  days: [
    {
      dayName: "Monday",
      ...
      livingSpaceId: "stay-nyc-plaza",
      activityIds: ["act-nyc-broadway", "act-nyc-centralpark-sunset"],
      notes: "Check into The Plaza Hotel; afternoon helicopter skyline tour followed by VIP Broadway orchestra show."
    },
    {
      dayName: "Tuesday",
      date: "Oct 13, 2026",
      ...
      livingSpaceId: "stay-nyc-plaza",
      activityIds: [],
      notes: "Morning stroll in Central Park, shopping along 5th Avenue, and fine dining in SoHo."
    },
    {
      dayName: "Wednesday",
      date: "Oct 14, 2026",
      destinationId: "new-york",
      transit: {
        type: "International Long-Haul Flight",
        from: "New York (JFK)",
        to: "Tokyo Haneda (HND)",
        duration: "14h 25m",
        estimatedCost: 1100
      ...
      livingSpaceId: null,
      activityIds: [],
      notes: "Direct transpacific flight crossing the International Date Line to Tokyo."
    },
    {
      dayName: "Thursday",
      date: "Oct 15, 2026",
      destinationId: "tokyo",
      livingSpaceId: "stay-tokyo-aman",
      activityIds: [],
      notes: "Arrive at Aman Tokyo Otemachi, traditional onsen bath, and welcome sake tasting."
    },
    {
      dayName: "Friday",
      date: "Oct 16, 2026",
      destinationId: "tokyo",
      livingSpaceId: "stay-tokyo-aman",
      activityIds: ["act-tokyo-shibuya-sky", "act-tokyo-tsukiji-sushi"],
      notes: "Morning Tsukiji sushi masterclass and omakase feast, evening sunset drinks atop Shibuya Sky."
    }
  ]
};

export const SHOWCASE_TRAVEL_PLAN = NYC_TOKYO_SHOWCASE_PLAN;

export const SHOWCASE_TRAVEL_PLANS = {
  "nyc-tokyo": NYC_TOKYO_SHOWCASE_PLAN,
  "south-america": {
    id: "south-america",
    title: "South American Wonders: Machu Picchu & São Paulo",
    traveler: "Alex Morgan",
    startDate: "2026-10-12",
    currency: "USD",
    collaborators: [
      { username: "alex_traveler", name: "Alex Morgan", role: "Trip Organizer", avatar: "👨‍✈️", status: "online" },
      { username: "elena_peru", name: "Elena Ramos", role: "Local Guide", avatar: "👩‍🏫", status: "online" }
    ],
    days: [
      {
        dayName: "Monday",
        ...
        livingSpaceId: "stay-mp-belmond",
        activityIds: ["act-mp-sungate"],
        notes: "Arrive via Hiram Bingham luxury train; early morning entrance to Intihuatana stone."
      },
      {
        dayName: "Tuesday",
        date: "Oct 13, 2026",
        destinationId: "machu-picchu",
        livingSpaceId: "stay-mp-belmond",
        activityIds: ["act-mp-huaynapicchu"],
        notes: "Huayna Picchu climb in the morning, followed by relaxing Andean herbal spa."
      },
      {
        dayName: "Wednesday",
        date: "Oct 14, 2026",
        ...
        livingSpaceId: null,
        activityIds: [],
        notes: "Scenic descent to Cusco, afternoon flight connecting into São Paulo Guarulhos."
      },
      {
        dayName: "Thursday",
        date: "Oct 15, 2026",
        destinationId: "sao-paulo",
        livingSpaceId: "stay-sp-fasano",
        activityIds: [],
        notes: "Check into Hotel Fasano Jardins, explore Vila Madalena and craft cocktails at sunset."
      },
      {
        dayName: "Friday",
        date: "Oct 16, 2026",
        destinationId: "sao-paulo",
        livingSpaceId: "stay-sp-fasano",
        activityIds: ["act-sp-paulista", "act-sp-gastronomy"],
        notes: "MASP art discovery in the morning, followed by signature D.O.M. tasting menu."
      }
    ]
  }
};
